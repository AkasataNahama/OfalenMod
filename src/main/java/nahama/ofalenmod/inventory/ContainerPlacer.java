...
public class ContainerPlacer extends ContainerWorldEditorBase {
	public ContainerPlacer(EntityPlayer player, TileEntityPlacer tileEntity) {
		super(player, tileEntity);
		// 設置機のインベントリの第一スロットの番号。
