...
import nahama.ofalenmod.inventory.ContainerRepairingMachine;
...
public class GuiRepairingMachine extends GuiContainer {
	...
	public GuiRepairingMachine(EntityPlayer player, TileEntityRepairingMachine tileEntity) {
		super(new ContainerRepairingMachine(player, tileEntity));
