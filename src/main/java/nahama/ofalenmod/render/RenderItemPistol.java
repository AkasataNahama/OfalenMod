...
public class RenderItemPistol implements IItemRenderer {
	private static final ResourceLocation resource = new ResourceLocation("ofalenmod:textures/models/laser_pistol.png");
