...
public class RenderLaser extends Render {
	...
	public void renderLaser(EntityLaser entity, double x, double y, double z, float par5, float par6) {
	...
	protected ResourceLocation getTexture(EntityLaser par1EntityArrow) {
