...
public class SmeltingMachine extends BlockContainer {
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ){
		((TileEntitySmeltingMachine)world.getTileEntity(x, y, z)).setGrade(getGrade(world, x, y, z));
		//GUIを開く
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
		...
		if (itemStack.hasDisplayName()) {
			((TileEntitySmeltingMachine) world.getTileEntity(x, y, z)).setCustomName(itemStack.getDisplayName());
		}
	}
	...
	public static void updateBlockState(boolean burning, World world, int x, int y, int z) {
		...
		if (tileentity != null) {
			...
			((TileEntitySmeltingMachine)tileentity).setGrade(getGrade(world, x, y, z));
		}
	}
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int meta) {
		if (!isBurning) {
			TileEntitySmeltingMachine tileentity = (TileEntitySmeltingMachine) world.getTileEntity(x, y, z);
